...
export default function MobileMenu({ workspace, isSeller, role }: { workspace: boolean; isSeller: boolean; role: string | null }) {
  ...
  const workspaceLinks = isSeller
    ...
    : role === 'rider'
      ? [['Deliveries', '/rider'], ['Notifications', '/notifications']]
      : [['Overview', '/admin'], ['Sellers', '/admin/sellers'], ['Riders', '/admin/riders'], ['Dispatch', '/admin/dispatch'], ['Products', '/admin/products'], ['Orders', '/admin/orders'], ['Payouts', '/admin/withdrawals'], ['Banners', '/admin/banners']]
