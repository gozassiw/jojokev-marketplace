...
export default async function SiteHeader() {
  ...
  const workspace = role === 'seller' || role === 'admin'
  const isSeller = role === 'seller'
  const workspaceHome = isSeller ? '/seller' : '/admin'
  const workspaceLabel = isSeller ? 'Seller workspace' : 'Admin control room'
